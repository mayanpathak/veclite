...
/// Record identifier.
///
/// veclite should be able to deal with a lot of writes and deletes. Using UUID
...
/// Metadata value.
///
/// veclite doesn't support nested objects in metadata for performance reasons.
...
/// veclite vector record.
///
/// This is the main data structure for veclite. It contains the vector data
